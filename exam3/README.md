# Lifting State Up Examples

Ref. https://facebook.github.io/react/docs/lifting-state-up.html

I made a small portion of code update using map to generate Celsius and
Fahrenheit input boxes from the code made by FB team in the ref. above.

I'd leave the documentation below which automatically generated by
`create-react-app` library for references purpose.
